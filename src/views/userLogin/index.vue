                ...
                <a-tab-pane key="1" tab="账号密码登录">
                    <a-form-model ref="ruleLogin" layout="horizontal" :rules="rules" :model="formInline" @submit="handleSubmit" @submit.native.prevent>
                        ...
                        <a-form-model-item prop="code">
                            <a-input class="code-1" v-model="formInline.code" type="text " size="small" placeholder="验证码" @keyup.enter.native="login('ruleLogin')">
                            </a-input>
                    ...
                    <a-form-model layout="horizontal" :model="fromPhone" @submit="handleSubmit" @submit.native.prevent>
                        <a-form-model-item>
                            <a-input v-model="fromPhone.numberPhone" placeholder="手机号">
                                <a-icon slot="prefix" type="mobile" theme="twoTone" style="color: rgba(0, 0, 0, 0.25)" />
                            </a-input>
                        </a-form-model-item>
                        <a-form-model-item>
                            <a-input class="code" v-model="fromPhone.code" type="password" placeholder="验证码">
                                <a-icon slot="prefix" type="mail" theme="twoTone" style="color: rgba(0, 0, 0, 0.25)" />
                            </a-input>
